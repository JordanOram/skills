---
name: "solomon-component-generator"
description: "Turn a clear product or client need into a finished frontend component or page that follows Solomon design and copy discipline."
...
# Solomon Component Generator

## When to use

Use when building pages, components, UI sections, dashboards, client rooms, portfolios, marketing pages, or working from wireframes/screenshots.
...
1. Read the project README, AGENTS.md, and design canon before coding.
2. Clarify the user, job, primary action, and state model.
3. Use the warm editorial Solomon design direction for Solomon/O&FA surfaces unless the project has its own design system.
4. Write clear copy before adding visual complexity.
5. Use existing components and patterns before inventing new ones.
6. Implement the smallest complete version, then verify in browser.
7. Report what changed and what still needs judgment.
