---
name: "solomon-crm-setup"
description: "Set up a lightweight CRM or opportunity pipeline that tracks real progress, not busywork."
...
Use for CRM, Airtable, Notion, Sheets, pipeline stages, follow-up tracker, deal flow, relationship tracking, or opportunity board setup.
...
1. Define what the pipeline is tracking: clients, design partners, sponsors, funders, jobs, productions, or opportunities.
2. Keep stages objective. A record only moves when something happened.
3. Add fields for owner, next action, last touch, trigger, source, status, value, confidence, and consent where relevant.
4. Choose the simplest tool Jordan will actually use.
5. Build or specify the table, views, and weekly review ritual.
6. Protect private relationship context. Share only what is appropriate.
7. Return the schema and operating rhythm.
