---
name: "solomon-deployment-setup"
description: "Plan and set up deployment paths for Solomon projects with clear staging, production, preview, and rollback discipline."
...
# Solomon Deployment Setup

## When to use

Use for deployment setup, hosting choice, Vercel, Zo Sites, Zo Space, services, preview URLs, production promotion, or release workflow.
...
1. Classify the project: Space route, Zo Site, managed service, external deployment, or internal tool.
2. Define development, staging, preview, and production environments if they are needed.
3. Identify secrets, domain needs, build commands, and health checks.
4. Set up the lowest-complexity deployment path that satisfies the job.
5. Create a smoke-test checklist before launch.
6. Do not promote to production or publish public pages without Jordan's approval.
7. Record the final URLs and rollback path.
