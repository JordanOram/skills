---
name: "solomon-infra-monitoring"
description: "Monitor services, logs, performance, costs, and reliability for Solomon projects, then propose focused fixes instead of vague alerts."
...
# Solomon Infrastructure Monitoring

## When to use

Use for service health, performance issues, uptime, logs, rate limits, database scaling, cost spikes, slow pages, or production reliability.
...
1. Identify the service, environment, owner, and user-facing promise.
2. Check health, logs, recent deploys, error rates, latency, storage, and usage where available.
3. Separate incident, degradation, and optimization work.
4. Name the user impact before naming the technical issue.
5. Propose one fix, one prevention step, and one watch metric.
6. Do not change production infrastructure without approval.
7. Record findings for future monitoring.
