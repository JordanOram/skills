---
name: "solomon-outreach-sequences"
description: "Turn a clear segment and offer into concise outreach angles, first messages, and follow-ups in Jordan or Solomon's voice."
...
# Solomon Outreach Sequences

## When to use

Use for cold outreach, warm outreach, design partner asks, follow-up sequences, LinkedIn DMs, email drafts, or referral asks.
...
1. Check existing contact briefs before drafting to a specific person.
2. Use the segment pain, trigger, and proof to create the angle.
3. Write short messages that sound human and specific.
4. One message, one ask. No fake urgency. No inflated claims.
5. Separate warm intro language from cold outbound language.
6. Draft follow-ups that add context, not pressure.
7. Present drafts for review. Do not send without approval.
