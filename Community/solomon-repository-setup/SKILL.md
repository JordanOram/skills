---
name: "solomon-repository-setup"
description: "Set up or audit a repo so it can support agent-assisted building without losing discipline."
...
# Solomon Repository Setup

## When to use

Use when creating a repo, cleaning structure, adding README, branch rules, .gitignore, AGENTS.md, or preparing a codebase for AI collaboration.
...
1. Inspect the current project root before changing anything.
2. Read README, AGENTS.md, package files, and existing conventions.
3. Define the repo purpose and surfaces before creating structure.
4. Add or improve README, .gitignore, setup instructions, branch doctrine, and agent guidance.
5. Prefer one coherent monorepo unless there is a real reason to split.
6. Do not push, commit, or change protected branches without approval.
7. Verify the repo can build or explain the blocker.
