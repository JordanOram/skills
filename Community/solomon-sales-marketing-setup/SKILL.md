---
name: "solomon-sales-marketing-setup"
description: "Set up the first practical sales and marketing system for Solomon, O&FA, or a freelancer client without turning it into theatre."
...
# Solomon Sales Marketing Setup

## When to use

Use when setting up distribution, GTM, first sales process, marketing system, campaign foundation, or the Sell side of the wheel.
...
1. Start with the client segment and the pain that makes action urgent.
2. Choose the simplest sales motion that can close or validate the first clients.
3. Define the site, offer, CRM, outreach, content, and feedback loop needed now.
4. Cut every channel that cannot be run consistently.
5. Reuse existing skills for brand, copy, outreach, social, and CRO where they fit.
6. Add measurement so the loop learns.
7. Return a practical setup plan with first artifacts.
